...
func newGatewayClassReconciler(t *testing.T, objects ...client.Object) (*Reconciler, client.Client) {
	t.Helper()
...
func reconcileGatewayClass(t *testing.T, reconciler *Reconciler, name string) {
	t.Helper()
